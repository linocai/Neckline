...
- Production runs **K10-v1.4 / Neckline 3.1.0 Build 49 / Schema 7**, backend release set **v3.1.0-b49**, since 2026-09-09. K9 and the earlier K8 chains are retired from active production and this worktree; do not reintroduce their runtime code, tables, routes, settings, compatibility shims, or UI placeholders. The explicit offline V3 migration owns the legacy deletion boundary; Git history is the archive.
