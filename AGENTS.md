...
- **Operational boundary (2026-09-21 15:59 CST):** User explicitly resumed all report switches and wants tonight’s report. API/worker active; four timers active/enabled, discovery control open, all four notification kinds enabled. Evening21:00, morning08:30; market18:30 with19:30/20:30 retry. Codex heartbeat is ACTIVE for the September21 report only, with20:55 preflight. Normal production model/search/market calls and delivery are authorized; no extra provider probes or recovery of old tasks. Verify live state; see current version record section13.
