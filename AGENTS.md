...
- Production is **K10-v2 / Neckline 3.2.0 Build 71 / Schema 8**, backend release set **v3.2.0-b71**, since 2026-09-11. K9 and the earlier K8 chains are retired from active production and this worktree; do not reintroduce their runtime code, tables, routes, settings, compatibility shims, or UI placeholders. The explicit offline V3 migration owns the legacy deletion boundary; Git history is the archive.
...
- **Current production state (2026-09-11 B71):** B71 `fd776f4` is deployed in Ningbo. The original September 10 21:00 task `task_c9c0feab5c83a08e8a17138ebfb0041a` / scan `scan_d39fbd5c631ea9a7df5f569dbd432b4d` completed: 7 cards, 22 research events, publication 01:06:26; APNs accepted both devices at 01:06:28. The deadline was missed. Actual authenticated report API and current Swift decoding pass after B71; retain partial upstream coverage and unknown market acquisition times. Do not recover/replay this completed report or resend its notification. API active+enabled, run control open, dedicated runner exited; normal worker/timers and old tasks stay paused. Rollback `/opt/neckline/data/backups/v3.2.0-b71-predeploy/` preserves B70 with the completed report and notification; never overwrite later writes. Mac remains B61 while locked, B71 staged bundle and B61 backup verified; iOS archive ready for Xcode. See execution sections 35–36.
- **Current released baseline:** 3.2.0 / both platforms Build 71. B71 accepts the persisted market acquisition metadata through a dedicated price-reference DTO; B70 preserves model recommendation counts and shared ranks. Earlier recovery, stopping-policy and fulltext reuse fixes are included. Follow `/Users/linotsai/Lino/whynotme/K10.md`: fixed 1,089-company universe, no 80/40 fulltext caps, labeled-unverified recommendation and daily company selection. B67 assets existed but were never deployed separately.
