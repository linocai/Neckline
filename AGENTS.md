...
- **Current release (2026-09-21):** B81 `626c902097a91481513ac9792257309858c9e031` is deployed following the explicitly authorized full release; see `archive/v3.5.0-b78_execution.md` section12. New morning starts08:30 with09:20 readable-result deadline; evening starts21:00 with no whole-report business deadline. Both clients release together, old reports/receipts remain readable, unranked materials are read-only and never formal recommendations/D1D2 samples.
- **Operational boundary:** API/worker active; four timers inactive/disabled and Codex heartbeat PAUSED. The existing discovery control remains open, but no schedule or old task was resumed. Release verification found35 terminal tasks, zero queued/running tasks or unsettled external attempts,31 sent notifications and zero company windows. Historical morning/evening reports remain failed/unpublished. Read live state before later operations; do not extrapolate this snapshot indefinitely.
