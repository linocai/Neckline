...
> - **Y6 ✅**:`archive/对照表/V2-⑬_删除前后对照表_20260803.md` 已补,端点面 11 条逐路由(纠正完工
...
- **✅ 已补**:`archive/对照表/V2-⑬_删除前后对照表_20260803.md`(端点 10 条 + 报告字段/节 + 停写六表 + 客户端渲染件,逐条「删除前 → 删除后」+ 出处 commit)。
...
- `PositionOpenIn`/`PositionOpenOut`/`PositionCloseIn` 蛇驼混排:**裁定维持现状不改**,
  登记入 `archive/对照表/V2_契约三方对拍_20260803.md` §七 第 4 条(四条理由:①这是入参/既有
