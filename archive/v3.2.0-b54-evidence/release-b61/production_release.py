"""One-shot, code-only B60 -> B61 cutover. No migration or provider call.
...
RELEASE = 'v3.2.0-b61'
PRIOR = 'v3.2.0-b60'
PRIOR_COMMIT = '03fb8613b0af60de98fd85bc8072456ed223d59f'
PAYLOAD = Path('/tmp/neckline-b61-release')
STAGE = PAYLOAD / 'staged'
BACKUP = ROOT / 'data/backups/v3.2.0-b61-predeploy'
BINDING = Path('/etc/neckline/k10.env')
ARCHIVE = 'Neckline-v3.2.0-b61-Backend.tar.gz'
