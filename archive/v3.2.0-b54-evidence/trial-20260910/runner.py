"""User-authorized single B59 evening trial; uses the production worker boundary.
...
task_id = sys.argv[1]
receipt = Path('/opt/neckline/data/backups/trial-b59-20260910-2100-pre/runner-result.json')
...
while True:
    ...
    claimed = run_once(db_path=db, task_id=task_id, worker_id='trial-b59-20260910-evening',
