"""One-shot, code-only B68 -> B69 cutover. No migration or provider call.
...
RELEASE = 'v3.2.0-b69'
PRIOR = 'v3.2.0-b68'
PRIOR_COMMIT = 'ee4903b01fefca07d7c93242ce2136bebf6b615e'
PAYLOAD = Path('/tmp/neckline-b69-release')
STAGE = PAYLOAD / 'staged'
BACKUP = ROOT / 'data/backups/v3.2.0-b69-predeploy'
BINDING = Path('/etc/neckline/k10.env')
ARCHIVE = 'Neckline-v3.2.0-b69-Backend.tar.gz'
...
def paused(api_active):
    assert h.unit_state('neckline-trial-20260910-evening-b68.service') == 'inactive'
