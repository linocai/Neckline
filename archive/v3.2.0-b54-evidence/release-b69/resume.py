...
backup = db.parent / 'backups/v3.2.0-b69-predeploy'
...
with urllib.request.urlopen('http://127.0.0.1:8002/api/v1/health') as response:
    assert json.load(response)['releaseSet'] == 'v3.2.0-b69'
...
value = {'taskId':task_id, 'scanId':scan_id, 'releaseSet':'v3.2.0-b69', 'frozenInputSha256':frozen,
