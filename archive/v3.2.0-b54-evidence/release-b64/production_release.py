"""One-shot, code-only B63 -> B64 cutover. No migration or provider call.
...
RELEASE = 'v3.2.0-b64'
PRIOR = 'v3.2.0-b63'
PRIOR_COMMIT = '5f229c0c5d1a926025b8156e52635391457fbe0c'
PAYLOAD = Path('/tmp/neckline-b64-release')
STAGE = PAYLOAD / 'staged'
BACKUP = ROOT / 'data/backups/v3.2.0-b64-predeploy'
BINDING = Path('/etc/neckline/k10.env')
ARCHIVE = 'Neckline-v3.2.0-b64-Backend.tar.gz'
