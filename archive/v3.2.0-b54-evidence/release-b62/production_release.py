"""One-shot, code-only B61 -> B62 cutover. No migration or provider call.
...
RELEASE = 'v3.2.0-b62'
PRIOR = 'v3.2.0-b61'
PRIOR_COMMIT = '99a83b3e38027734b7d1d69d3622522609478132'
PAYLOAD = Path('/tmp/neckline-b62-release')
STAGE = PAYLOAD / 'staged'
BACKUP = ROOT / 'data/backups/v3.2.0-b62-predeploy'
BINDING = Path('/etc/neckline/k10.env')
ARCHIVE = 'Neckline-v3.2.0-b62-Backend.tar.gz'
