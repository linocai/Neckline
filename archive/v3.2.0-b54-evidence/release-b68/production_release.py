"""One-shot, code-only B66 -> B68 cutover. No migration or provider call.
...
PAYLOAD = Path('/tmp/neckline-b68-release')
STAGE = PAYLOAD / 'staged'
BACKUP = ROOT / 'data/backups/v3.2.0-b68-predeploy'
BINDING = Path('/etc/neckline/k10.env')
ARCHIVE = 'Neckline-v3.2.0-b68-Backend.tar.gz'
