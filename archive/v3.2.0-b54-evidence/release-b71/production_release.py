"""One-shot, code-only B70 -> B71 cutover. No migration or provider call.
...
RELEASE = 'v3.2.0-b71'
PRIOR = 'v3.2.0-b70'
PRIOR_COMMIT = '17c0022ff40684dbc16e6e5f6135b6bbd8c8ecf7'
PAYLOAD = Path('/tmp/neckline-b71-release')
STAGE = PAYLOAD / 'staged'
BACKUP = ROOT / 'data/backups/v3.2.0-b71-predeploy'
BINDING = Path('/etc/neckline/k10.env')
ARCHIVE = 'Neckline-v3.2.0-b71-Backend.tar.gz'
...
def paused(api_active):
    assert h.unit_state('neckline-trial-20260910-evening-b70.service') == 'inactive'
