"""B63 read-only release acceptance; offline mode denies all socket connections."""
import argparse
import json
import os
...
if args.mode == 'offline':
    ...
    os.environ['API_TOKEN'] = 'offline-b63-release-token'
...
def verify(get):
    ...
    assert health['releaseSet'] == 'v3.2.0-b63' and health['status'] == 'ok'
    out['health'] = health
