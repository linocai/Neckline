"""One-shot, code-only B62 -> B63 cutover. No migration or provider call.
...
RELEASE = 'v3.2.0-b63'
PRIOR = 'v3.2.0-b62'
PRIOR_COMMIT = '4500397c4c4b0ac18d6630ae6870d8f756927ff5'
PAYLOAD = Path('/tmp/neckline-b63-release')
STAGE = PAYLOAD / 'staged'
BACKUP = ROOT / 'data/backups/v3.2.0-b63-predeploy'
BINDING = Path('/etc/neckline/k10.env')
ARCHIVE = 'Neckline-v3.2.0-b63-Backend.tar.gz'
