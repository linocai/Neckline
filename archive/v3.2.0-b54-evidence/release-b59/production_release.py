"""One-shot, code-only B57 -> B59 cutover. No migration or provider call.
...
RELEASE = 'v3.2.0-b59'
PRIOR = 'v3.2.0-b57'
PRIOR_COMMIT = '8e5cec47b599e152fc32dacbf32a43ec7b9f8b9b'
PAYLOAD = Path('/tmp/neckline-b59-release')
STAGE = PAYLOAD / 'staged'
BACKUP = ROOT / 'data/backups/v3.2.0-b59-predeploy'
BINDING = Path('/etc/neckline/k10.env')
ARCHIVE = 'Neckline-v3.2.0-b59-Backend.tar.gz'
