"""One-shot, code-only B59 -> B60 cutover. No migration or provider call.
...
RELEASE = 'v3.2.0-b60'
PRIOR = 'v3.2.0-b59'
PRIOR_COMMIT = 'c228c0f2e9dc362876c467a06bb365cad9563107'
PAYLOAD = Path('/tmp/neckline-b60-release')
STAGE = PAYLOAD / 'staged'
BACKUP = ROOT / 'data/backups/v3.2.0-b60-predeploy'
BINDING = Path('/etc/neckline/k10.env')
ARCHIVE = 'Neckline-v3.2.0-b60-Backend.tar.gz'
