"""User-authorized single B60 evening trial; uses the production worker boundary.
...
task_id = sys.argv[1]
receipt = Path('/opt/neckline/data/backups/v3.2.0-b60-predeploy/resume-runner-result.json')
...
while True:
    ...
    claimed = run_once(db_path=db, task_id=task_id, worker_id='trial-b60-20260910-evening',
