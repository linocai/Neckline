"""One-shot, code-only B69 -> B70 cutover. No migration or provider call.
...
RELEASE = 'v3.2.0-b70'
PRIOR = 'v3.2.0-b69'
PRIOR_COMMIT = '3ab72755c8abcb3edb0abb39648632f3ef5f3b63'
PAYLOAD = Path('/tmp/neckline-b70-release')
STAGE = PAYLOAD / 'staged'
BACKUP = ROOT / 'data/backups/v3.2.0-b70-predeploy'
BINDING = Path('/etc/neckline/k10.env')
ARCHIVE = 'Neckline-v3.2.0-b70-Backend.tar.gz'
...
def paused(api_active):
    assert h.unit_state('neckline-trial-20260910-evening-b69.service') == 'inactive'
