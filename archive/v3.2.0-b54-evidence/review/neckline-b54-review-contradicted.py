...
with pytest.MonkeyPatch.context() as mp:
    ...
    mp.setattr(pipeline,'TuShareMajorNewsAdapter',DenialNews)
    observed={} 
    ...
    print('DENIAL_REPORT', {'status':report['status'],'updatedCards':report['updatedCards'],'addedCards':report['addedCards']})
