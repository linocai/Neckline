"""One-shot, code-only B64 -> B65 cutover. No migration or provider call.
...
RELEASE = 'v3.2.0-b65'
PRIOR = 'v3.2.0-b64'
PRIOR_COMMIT = '0c0a789d7c3cde0b0020400dacfe1dde7787438a'
PAYLOAD = Path('/tmp/neckline-b65-release')
STAGE = PAYLOAD / 'staged'
BACKUP = ROOT / 'data/backups/v3.2.0-b65-predeploy'
BINDING = Path('/etc/neckline/k10.env')
ARCHIVE = 'Neckline-v3.2.0-b65-Backend.tar.gz'
