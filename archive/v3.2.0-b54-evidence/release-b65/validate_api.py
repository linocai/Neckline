"""B65 read-only release acceptance; offline mode denies all socket connections."""
import argparse
import json
import os
...
if args.mode == 'offline':
    ...
    os.environ['API_TOKEN'] = 'offline-b65-release-token'
...
def verify(get):
    ...
    assert health['releaseSet'] == 'v3.2.0-b65' and health['status'] == 'ok'
    out['health'] = health
