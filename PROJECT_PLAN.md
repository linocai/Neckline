...
- 目标为 **3.2.0 / 双端 Build 57 / Schema 8 / K10-v2**。版本三处和客户端 Build 必须一致；已于 2026-09-10 发布；API 恢复读取，报告开关、worker 和全部 timer 仍保持暂停。
...
施工、独立复查与一条龙发布均已完成。六项 GitHub 资产回下载校验通过，运维记录已同步，本轮临时副本已收口。无未完成发布项。
