...
## 五B、K2 策略研究 Plan(当前施工件 · 纯研究,不动生产 / 不动纪律章程)
...
- **[研究·当前施工件] K2 策略研究(情绪门控 × 主线票池 × 短线进出)**:施工图 **§五B**,六研究件 B1–B6,产出 `research/k2_report.md` + K2 候选大脑(`strategy_versions.K2`,`is_active=0` 不激活)+ 「K2 vs K1 对比裁决书」。中心命题 = 阶段 1 被否的「追强势」在「情绪进攻段 × 主线成员」子域期望未检验。**K2 激活 / 部署过门后另行立项,不在本次范围**;纪律章程 §2.1 一字不动、生产零改动。
