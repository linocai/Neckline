...
**2026-07-27 · 🔴 v1.3 章程已在生产激活(@builder-pro + 用户明确授权;staged 步骤 2 落地 = 用户的纪律判定标准自此真正改变)。** 激活时刻 `activated_at=2026-07-27T04:01:27+00:00`(北京 12:01:27,周一盘中午休),**现役 = `v1.3`(内核血缘 K1)**,K1/K4/v1.2 三行 `is_active=0`。授权链:用户 2026-07-27 明确「上新章程」+ 生产 `positions` 0 行(满足「清仓后才切」铁律)+ 用户即将导入持仓(导入后切换器会硬拒,时间窗只有现在)。**未回滚。**
