//
//  ReviewView.swift
//  Neckline — 🔴 **复盘板块**(三板块之一;V2.5.0 S12 按架构 §六 重做)。
//
...
//
//  ⚠ **本页刻意不呈现「校准段」与「观察项段」**:服务端还在发,但它们的内容仍是
//  **K8 语义**(Tier 入场信号正确率 / C·Z·Y 引擎版本 / 涨停簇 lift 门槛),K9 之下的
//  形状未定义 —— 已登记 PROJECT_PLAN §13.1-B8 等用户裁定。⛔ 不渲染成一段永远空着的壳:
