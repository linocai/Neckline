...
# `-p1` = partial-1:v1.4.0 的**计划外小步部署**,只上了第 ① 块 P0 地基(①-A 买入日契约 /
# ①-B 停牌口径 / ①-C 概念板块日更 + 过期告警),②~⑧ 尚未施工。理由:`002036.SZ` 停牌票
# 的假警报有硬时限(0729 09:26 盘前误推「D5 离场」、16:35 永久错误定格),等第 ⑨ 块完整
# 部署来不及。**第 ⑨ 块完整部署时改回 `v1.4.0`** —— 看到 `-p1` 就知道云上是个半版。
VERSION = "v1.4.0-p1"
API_PREFIX = "/api/v1"
