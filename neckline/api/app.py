...
# v1.5.1(2026-07-30,两线 review 黄牌集中修复:verdict 标签劫持 / 同日重跑标签并存 /
# 章程标签硬编):同上,本行是纯本地源码常量,与 `project.yml`/`pbxproj` 同一次提交动;
# 生产在部署窗口重启前仍返 v1.5.0,`/health` 返 v1.5.1 即为本次部署的到位判据。
VERSION = "v1.5.1"
API_PREFIX = "/api/v1"
