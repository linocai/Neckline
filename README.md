...
当前生产版本为 V2.5.1 Build 12；V2.5.2 Build 13 已完成源码推送和双端签名归档，但生产
部署因尚未配置 S3、备份公钥与隔离恢复验证器而停在发布前备份门禁。运行链路仍是 K9。
...
- V2.5.2 Build 13 源码提交为 `5e299a6`；双端归档位于
  `/Users/linotsai/Lino/releases/Neckline/v2.5.2-b13-20260824/`，尚未换包。
