...
新晨报交易日 **08:30** 开始，**09:20** 前提供可读结果；晚报保持前一自然日 **21:00** 开始，不设整报业务截止。局部失败可交付部分报告；排序失败或请求费用待确认时可查看安全材料或诊断，不产生正式推荐、选择或观察样本。**9月21日15:59按用户指令恢复全部报告开关：四个定时器开启，今晚21:00晚报、明早08:30晨报；今晚报告跟踪已恢复。旧任务不恢复。**
